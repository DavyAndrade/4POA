...
<body class="h-full bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    <div class="flex h-full"><!-- Mobile Header -->
        <header
            ...
            <div class="w-8"></div>
            <h1 id="mobile-system-title" class="text-lg font-semibold text-center flex-1">Central de Vagas</h1><button
                onclick="toggleTheme()" class="p-2 rounded-lg hover:bg-slate-700 transition-colors"> <span
                    id="mobile-theme-icon" class="text-xl">🌙</span> </button>
        </header><!-- Sidebar -->
        <aside id="sidebar"
            ...
            <div class="flex items-center justify-between p-6 bg-slate-900 border-b border-slate-700">
                ...
                </div><button onclick="toggleSidebar()"
                    class="p-2 rounded-lg hover:bg-slate-700 transition-colors collapse-btn"> <span
                        class="text-lg">◀</span> </button>
            </div><!-- Navigation Container -->
            <div class="flex flex-col flex-1 justify-between overflow-y-auto"><!-- Main Navigation -->
                <nav class="py-4">
                    <div class="nav-item active px-6 py-3 flex items-center gap-3 cursor-pointer hover:bg-slate-700 border-l-4 border-transparent hover:border-blue-500 transition-all"
                        data-page="home"><span class="nav-icon text-xl w-6 text-center flex-shrink-0">🏠</span> <span
                            class="nav-text">Página Inicial</span>
                        <div
                    ...
                    <div class="nav-item px-6 py-3 flex items-center gap-3 cursor-pointer hover:bg-slate-700 border-l-4 border-transparent hover:border-blue-500 transition-all"
                        data-page="vagas"><span class="nav-icon text-xl w-6 text-center flex-shrink-0">💼</span> <span
                            class="nav-text">Consulta de Vagas</span>
                        <div
                            class="nav-tooltip absolute left-16 bg-slate-800 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 invisible transition-all z-50 shadow-lg">
                            Consulta de Vagas
                        </div>
                    ...
                    <div class="nav-item px-6 py-3 flex items-center gap-3 cursor-pointer hover:bg-slate-700 border-l-4 border-transparent hover:border-blue-500 transition-all"
                        data-page="cadastro"><span class="nav-icon text-xl w-6 text-center flex-shrink-0">👤</span>
                    ...
                    <div class="nav-item px-6 py-3 flex items-center gap-3 cursor-pointer hover:bg-slate-700 border-l-4 border-transparent hover:border-blue-500 transition-all"
                        data-page="empresa"><span class="nav-icon text-xl w-6 text-center flex-shrink-0">🏢</span> <span
                            class="nav-text">Área da Empresa</span>
                        <div
                            class="nav-tooltip absolute left-16 bg-slate-800 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 invisible transition-all z-50 shadow-lg">
                            Área da Empresa
                        </div>
                    </div>
                </nav><!-- Theme Toggle - Bottom -->
        ...
        <main class="flex-1 overflow-y-auto pt-16 md:pt-0 pb-20 md:pb-0">
            <div class="p-4 md:p-8 max-w-7xl mx-auto"><!-- Página Inicial -->
                <section id="home" class="content-section">
                    <div class="mb-8">
                        <h2 id="welcome-message"
                            class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">Bem-vindo à
                            Central de Vagas</h2>
                ...
                </section><!-- Consulta de Vagas -->
                <section id="vagas" class="content-section hidden">
                    <div class="mb-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
                        ...
                        <div class="space-y-4">
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Buscar
                                    por palavra-chave</label> <input type="text"
                                    placeholder="Ex: Java, Design, Marketing..."
                ...
                </section><!-- Cadastro do Aluno -->
                <section id="cadastro" class="content-section hidden">
                    <div class="mb-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
                        ...
                        <div class="space-y-4">
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nome
                                    Completo</label> <input type="text" placeholder="Digite seu nome completo"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div><label
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
                        ...
                        <div class="space-y-4">
                            <div><label
                                    ...
                                    Técnicas</label> <textarea placeholder="Ex: Java, Python, SQL, Git, HTML/CSS..."
                                    rows="4"
                            ...
                            <div><label
                                    ...
                                    Profissional</label> <textarea
                                    placeholder="Descreva suas experiências anteriores..." rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white resize-vertical"></textarea>
                            </div>
                            <div class="flex flex-col md:flex-row gap-3"><button
                                    class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
                                    Salvar Cadastro </button> <button
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm">
                        ...
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
                            <li class="flex items-center gap-2"><span class="text-green-500">✅</span> <span>Cadastro
                                    completo: +50 pontos</span></li>
                            <li class="flex items-center gap-2"><span class="text-green-500">✅</span> <span>Primeira
                                    candidatura: +30 pontos</span></li>
                            <li class="flex items-center gap-2"><span class="text-green-500">✅</span> <span>Currículo
                                    atualizado: +20 pontos</span></li>
                            <li class="flex items-center gap-2"><span class="text-green-500">✅</span> <span>Avaliação
                                    positiva de empresa: +40 pontos</span></li>
                        </ul>
                    </div>
                </section><!-- Área da Empresa -->
                <section id="empresa" class="content-section hidden">
                    <div class="mb-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
                        ...
                        <div class="space-y-4">
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nome da
                                    Empresa</label> <input type="text" placeholder="Digite o nome da empresa"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white">
                            </div>
                            <div><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Título
                                    da Vaga</label> <input type="text" placeholder="Ex: Desenvolvedor Java Jr"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div><label
                            ...
                            <div><label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Descrição da
                                    Vaga</label> <textarea
                                    placeholder="Descreva as responsabilidades, requisitos e benefícios..." rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white resize-vertical"></textarea>
                            </div><button
                                class="w-full md:w-auto px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm">
                        ...
                        <p class="text-gray-600 dark:text-gray-300"><strong>Padrão DAO:</strong> Cada tabela possui uma
                            classe DAO dedicada para operações CRUD, garantindo separação de responsabilidades e
                            facilidade de manutenção.</p>
                    </div>
                </section>
            </div>
        </main><!-- Bottom Navigation - Mobile only -->
        <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 z-40">
            <div class="flex">
                <div class="bottom-nav-item active flex-1 flex flex-col items-center py-2 px-1 text-blue-400 border-t-2 border-blue-400"
                    data-page="home"><span class="text-xl mb-1">🏠</span> <span
                        class="text-xs font-medium">Início</span>
                </div>
                <div class="bottom-nav-item flex-1 flex flex-col items-center py-2 px-1 text-gray-400 hover:text-white transition-colors"
                    data-page="vagas"><span class="text-xl mb-1">💼</span> <span
                        class="text-xs font-medium">Vagas</span>
                </div>
                <div class="bottom-nav-item flex-1 flex flex-col items-center py-2 px-1 text-gray-400 hover:text-white transition-colors"
                    data-page="cadastro"><span class="text-xl mb-1">👤</span> <span
                        class="text-xs font-medium">Cadastro</span>
                </div>
                <div class="bottom-nav-item flex-1 flex flex-col items-center py-2 px-1 text-gray-400 hover:text-white transition-colors"
                    data-page="empresa"><span class="text-xl mb-1">🏢</span> <span
                        class="text-xs font-medium">Empresa</span>
                </div>
            </div>
        </nav>
    </div>
    <script>
        ...
        function navigateToPage(targetPage) {
            ...
            document.querySelectorAll('.nav-item[data-page]').forEach(item => {
                item.classList.remove('active', 'bg-slate-700', 'border-blue-500', 'text-blue-400');
            });

            const sidebarItem = document.querySelector(`.nav-item[data-page="${targetPage}"]`);
            if (sidebarItem) {
                sidebarItem.classList.add('active', 'bg-slate-700', 'border-blue-500', 'text-blue-400');
            }

            // Update bottom navigation
            document.querySelectorAll('.bottom-nav-item').forEach(item => {
                item.classList.remove('active', 'text-blue-400', 'border-blue-400');
                item.classList.add('text-gray-400');
            });

            const bottomItem = document.querySelector(`.bottom-nav-item[data-page="${targetPage}"]`);
            if (bottomItem) {
                bottomItem.classList.remove('text-gray-400');
                bottomItem.classList.add('active', 'text-blue-400', 'border-blue-400');
            }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (homeNavItem) {
                homeNavItem.classList.add('active', 'bg-slate-700', 'border-blue-500', 'text-blue-400');
            }
        });
    </script>
