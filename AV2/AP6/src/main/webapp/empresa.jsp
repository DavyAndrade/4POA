    ...
    <div class="flex h-full">
        ...
        <aside id="sidebar" class="hidden md:flex flex-col bg-slate-800 text-white shadow-xl transition-all duration-300 w-72 sidebar-expanded">
            ...
            <div class="flex flex-col flex-1 justify-between overflow-y-auto">
                ...
                <nav class="py-4">
                    ...
                    <a href="empresa.jsp" class="nav-item active bg-slate-700 border-blue-500 text-blue-400 px-6 py-3 flex items-center gap-3 cursor-pointer hover:bg-slate-700 border-l-4 border-transparent hover:border-blue-500 transition-all block no-underline text-inherit">
                        <span class="nav-icon text-xl w-6 text-center flex-shrink-0">🏢</span>
        ...
        <main class="flex-1 overflow-y-auto pt-16 md:pt-0 pb-20 md:pb-0">
            <div class="p-4 md:p-8 max-w-7xl mx-auto">
                <!-- Área da Empresa -->
<div class="mb-8">
    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">🏢 Área da Empresa</h2>
    <p class="text-gray-600 dark:text-gray-300 text-lg">Gerencie suas vagas e encontre os melhores talentos</p>
</div>
...
<div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <textarea placeholder="Descreva as responsabilidades, requisitos e benefícios..." rows="4"
        ...
        <button class="w-full md:w-auto px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
            Publicar Vaga
        </button>
    </div>
</div>
...
<!-- Published Jobs -->
<div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm mb-6">
    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Minhas Vagas Publicadas</h3>
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-200 dark:border-gray-700">
                    <th class="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">Vaga</th>
            ...
            <tbody>
                <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-slate-700">
                    <td class="py-3 px-4 text-gray-600 dark:text-gray-300">Desenvolvedor Java Jr</td>
                    ...
                    <td class="py-3 px-4">
                        <div class="flex gap-2">
                            <button class="px-3 py-1 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 transition-colors">Ver</button>
                            <button class="px-3 py-1 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 transition-colors">Editar</button>
                        </div>
                    </td>
                </tr>
...
<div class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm">
    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">💾 Banco de Dados Relacional</h3>
    <p class="text-gray-600 dark:text-gray-300 mb-4">O sistema utiliza MySQL/PostgreSQL com as seguintes tabelas principais:</p>
